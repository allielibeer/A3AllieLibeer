...
const cacheName = 'A3AllieLibeer-2021-03-15 09:24:53.370551'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'A3AllieLibeer'.length) === 'A3AllieLibeer') {
